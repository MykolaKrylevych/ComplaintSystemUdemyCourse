...
Revision ID: 814040d0f16d
Revises: 
Create Date: 2024-07-07 22:54:23.695068
...
def upgrade() -> None:
    ...
    sa.Column('state', sa.Enum('pending', 'approved', 'rejected', name='state'), server_default='pending', nullable=True),
